...
const passwords_controller_1 = require("./passwords.controller");
const passwords_service_1 = require("./passwords.service");
let PasswordsModule = class PasswordsModule {
};
PasswordsModule = __decorate([
    (0, common_1.Module)({
        controllers: [passwords_controller_1.PasswordsController],
        providers: [passwords_service_1.PasswordsService],
        exports: [passwords_service_1.PasswordsService],
    })
], PasswordsModule);
